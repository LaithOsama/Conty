...
export packagelist="${audio_pkgs} ${video_pkgs} ${wine_pkgs} ${devel_pkgs} \
	vi ttf-dejavu ttf-liberation lutris steam  mpv pcmanfm \
	htop xorg-xwayland chromium \
	steam-native-runtime gamemode lib32-gamemode jre17-openjdk \
	steamtinkerlaunch mangohud lib32-mangohud qt6-wayland wayland \
	lib32-wayland qt5-wayland retroarch xorg-server-xephyr \
	obs-studio gamehub minigalaxy legendary gamescope prismlauncher \
	...
	libretro-retrodream libretro-yabause dwarfs fuse-overlayfs"
